    ...
    define("fetch", ["exports"], function(self) {
      ...
      if (global.Ember.Test) {
        ...
        self["default"] = function() {
          ...
          return self.fetch.apply(global, arguments).then(
            function(response) {
              response
                .clone()
                .blob()
...
define("ember-fetch/mixins/adapter-fetch", [
  "exports",
  "fetch",
  "ember-fetch/utils/mung-options-for-fetch",
  "ember-fetch/utils/determine-body-promise"
], function(exports, _fetch, _mungOptionsForFetch, _determineBodyPromise) {
  "use strict";
...
define("ember-fetch/utils/determine-body-promise", ["exports"], function(
  exports
) {
  "use strict";
    ...
    return response.text().then(function(payload) {
      ...
      try {
        ...
        if (
          ...
          console.warn(
            "This response was unable to be parsed as json.",
            payload
          );
        }
      }
...
define("ember-fetch/utils/mung-options-for-fetch", [
  "exports",
  "ember-fetch/utils/serialize-query-params",
  "ember-fetch/types"
], function(exports, _serializeQueryParams, _types) {
  "use strict";
    ...
    if (hash.data) {
      ...
      if (hash.method === "GET" || hash.method === "HEAD") {
        ...
        if (Object.keys(hash.data).length) {
          ...
          hash.url += `${queryParamDelimiter}${(0,
          _serializeQueryParams.serializeQueryParams)(hash.data)}`;
        }
      } else {
...
define("ember-fetch/utils/serialize-query-params", [
  "exports",
  "ember-fetch/types"
], function(exports, _types) {
  "use strict";
