...
define("{{applicationName}}/initializers/error-handler", ["exports"], function(
  _exports
) {
  "use strict";
...
define("{{applicationName}}/instance-initializers/setup-fetch", [
  "exports",
  "fetch"
  ...
  function patchFetchForRelativeURLs(instance) {
    ...
    const protocol =
      request.protocol === "undefined:" ? "http:" : request.protocol; // host is cp
